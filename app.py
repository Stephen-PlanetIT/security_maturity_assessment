...
# --- UNIFIED SIDEBAR (Input Once, Pitch Twice) ---
with st.sidebar:
...
# Shared dictionary constructed on every interaction
client_inputs = {
...
# ==========================================
    ...
    custom_scenario = st.text_input("Custom Scenario Override (Optional)", placeholder="e.g., BlackBasta ransomware deployment")
